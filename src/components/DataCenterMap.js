...
const locations = [
  // North America
  { name: 'California, USA', top: '50%', left: '15%', countryCode: 'US' },
  { name: 'Canada (central)', top: '25%', left: '20%', countryCode: 'CA' },
  { name: 'Iowa, USA', top: '40%', left: '22%', countryCode: 'US' },
  { name: 'Montreal, Quebec', top: '35%', left: '29%', countryCode: 'CA' },
  { name: 'Nevada, USA', top: '51%', left: '15%', countryCode: 'US' },
  { name: 'Ohio, USA', top: '40%', left: '25%', countryCode: 'US' },
  { name: 'Oregon, USA', top: '45%', left: '14%', countryCode: 'US' },
  { name: 'South Carolina, USA', top: '50%', left: '25%', countryCode: 'US' },
  { name: 'Texas, USA', top: '55%', left: '20%', countryCode: 'US' },
  { name: 'Toronto, Ontario', top: '38%', left: '27%', countryCode: 'CA' },
  { name: 'Utah, USA', top: '50%', left: '16%', countryCode: 'US' },
  ...
  { name: 'Eemshaven, Netherlands', top: '36%', left: '48%', countryCode: 'NL' },
  { name: 'Frankfurt, Germany', top: '39%', left: '51%', countryCode: 'DE' },
  { name: 'Hamina, Finland', top: '22%', left: '59%', countryCode: 'FI' },
  ...
  { name: 'Saint-Ghislain, Belgium', top: '38%', left: '47%', countryCode: 'BE' },
  { name: 'Stockholm, Sweden', top: '23%', left: '58%', countryCode: 'SE' },
  { name: 'Warsaw, Poland', top: '30%', left: '56%', countryCode: 'PL' },
  ...
  { name: 'Melbourne, Australia', top: '89%', left: '87%', countryCode: 'AU' },
  ...
  { name: 'Sydney, Australia', top: '84%', left: '90%', countryCode: 'AU' },
  ...
  // South America
  { name: 'Santiago, Chile', top: '80%', left: '26%', countryCode: 'CL' },
  { name: 'São Paulo, Brazil', top: '70%', left: '32%', countryCode: 'BR' },
  // Africa
  { name: 'Cape Town, SA', top: '80%', left: '51%', countryCode: 'ZA' },
];
